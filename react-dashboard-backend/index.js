...
app.get("/api/products/:id", (req, res) => {
    const product = producuts.find((product) => product.id === parseInt(req.params.id))
    res.json(product)
})

// add product
app.post("/api/products", (req, res) => {
    const product = product.find((product) => product.id === parseInt(req.params.id))
    res.json(product);
})
...
app.delete("/api/users/:id", (req, res) => {
  ...
  console.log(`Users before: ${initialCount}, after: ${users.length}`);
